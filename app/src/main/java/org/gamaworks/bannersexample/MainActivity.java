...
public class MainActivity extends AppCompatActivity implements Banners.LoadBannerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        banners.setActiveIndicatorColor(R.color.blue);
...
//        urls.add("http://www.mobilab.unina.it/workshop_dd4lcci/EDCC-2010-banner-big.jpg"); // Too big...
        urls.add("http://media.newbee.ng//mobi_commerce/565c2c447f472/home_banners/565f0bd09d556.jpg");
        urls.add("http://media.newbee.ng//mobi_commerce/565c2c447f472/home_banners/565f0bd09d5c4.jpg");
        urls.add("http://media.newbee.ng//mobi_commerce/565c2c447f472/home_banners/565f0bd09d60f.jpg");
